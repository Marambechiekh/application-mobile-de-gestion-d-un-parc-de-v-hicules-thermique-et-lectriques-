...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(
      title: Text(_document == null ? 'Ajouter Véhicule' : 'Modifier Véhicule'),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildNumberField('coutAcquisition', 'Coût (€)', Icons.payments
                , isDouble: true),
                SizedBox(height: 20),
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        if (_document == null) {
          ...
          await _firestore.collection('vehicles').doc(_document!.id).update(data);
        }
